		...
		\section{Langage fonctionnel réactif}\label{SECDConc4}
			...
			\subsection{Les bases de la réactivité de la machine}
				...
				\subsubsection{La présence d'un signal}
					...
					\smallbreak
					C'est ici que la notion de temps logique va nous être utile. Via l'initialisation d'un signal on sait que l'on a un booléen pour savoir si un signal est émit donc le cas est émit est simple mais si il ne l'est pas ? 
					\smallbreak
					...
					Maintenant que l'on sait différencier les threads, 
