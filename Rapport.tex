...
\begin{document}
	...
	\section{Recherche d'Informations}\label{Recherche}
		...
		\textbf{\textit{Soit $\langle T,TL,SI,IP\rangle$ $\langle I,S,E,C,TL,SI,D,H,IP\rangle$ avec :}}
		...
		\begin{enumerate}
			...
			\begin{itemize}
				...
				\item[] à faire \textbf{Ajouter dans un signal :} On ajoute une constante dans une liste de valeurs d'un signal via la fonction $\rho$
				\smallbreak
				$\langle\langle I,s$ $b$ $S,E,put$ $C,D\rangle,TL,SI,IP\rangle
				...
				\longrightarrow_{secdv4} \langle\langle I,signal$ $S,E,C,D\rangle,TL,SI',IP\rangle$
				...
				\smallbreak
				$\langle I,\langle\langle X',C''\rangle,E\rangle$ $\langle\langle X,C'\rangle,E\rangle$ $s$ $S,E,present$ $C,TL,SI,IP\rangle 
				\longrightarrow_{secdv4} \langle\langle I,S,E,C'$ $C,D\rangle,TL,SI,IP\rangle$ \\
				...
				\smallbreak
				$\langle\langle I,V$ $S,E,\epsilon,\emptyset\rangle,\langle I',S',E',C,D\rangle$ $TL,SI,IP\rangle 
				\longrightarrow_{secdv4} \langle\langle I',V$ $S',E',C,D\rangle,TL,SI,IP\rangle$
				\item[]
				...
				\smallbreak
				$\langle\langle I,V$ $S,E,\epsilon,\emptyset \rangle ,\emptyset,SI,IP\rangle 
				\longrightarrow_{secdv4} \langle\langle I,V$ $S,E,\epsilon,\emptyset\rangle,TL,SI',IP\rangle$
				avec  $\tau(SI)$ = ($SI',TL$)
				\item[]
