	...
	\section{Recherche d'Informations}\label{Recherche}
		...
		\section{Dernière version de la machine SECD concurrente}\label{SECDConc4}
			...
			\begin{enumerate}
				...
				\\ \longrightarrow_{secdv4} \langle I,V$ $S,E,C,TL,SI,D,H,IP\rangle$ avec $\delta(b_{1}...b_{n})$ = V
				\item[]
				...
				\item[]
				\item $\langle I,s$ $b$ $S,E,get$ $C,TL,\langle CS,\{...,\langle s,\{...,\langle b,\{...,\langle n,\{...,I,...\}\rangle,\langle m,\{...\}\rangle,...\},\{...\}\rangle,...\}\rangle,...\}\rangle,D,H,IP\rangle \\\longrightarrow_{secdv4} \langle I,n$ $S,E,C,TL,\langle CS,\{...,\langle s,\{...,\langle b,\{...,\langle n,\{...\}\rangle,\langle m,\{...,I\}\rangle,...\},\{...\}\rangle,...\}\rangle,...\}\rangle,D,H,IP\rangle$
				\item[]
				\item $\langle I,s$ $b$ $S,E,get$ $C,TL,\langle CS,\{...,\langle s,\{...,\langle b,\{...,\langle n,\{...,I,...\}\rangle\},\{...\}\rangle,...\}\rangle,...\}\rangle,D,H,IP\rangle \\\longrightarrow_{secdv4} \langle I,n$ $S,E,C,TL,\langle CS,\{...,\langle s,\{...,\langle b,\{...,\langle n,\{...\}\rangle\},\{...,I\}\rangle,...\}\rangle,...\}\rangle,D,H,IP\rangle$
				\item[]
				\item $\langle I,s$ $b$ $S,E,get$ $C,TL,\langle CS,\{...,\langle s,\{...,\langle b,\{\langle n,\{\}\rangle,\langle m,\{...\}\rangle,...\},\{...\}\rangle,...\}\rangle,...\}\rangle,D,H,IP\rangle \\\longrightarrow_{secdv4} \langle I,n$ $S,E,C,TL,\langle CS,\{...,\langle s,\{...,\langle b,\{\langle n,\{\}\rangle,\langle m,\{...,I\}\rangle,...\},\{...\}\rangle,...\}\rangle,...\}\rangle,D,H,IP\rangle$
				\item[]
				\item $\langle I,s$ $b$ $S,E,get$ $C,TL,\langle CS,\{...,\langle s,\{...,\langle b,\{...\},\{...,I,...\}\rangle,...\}\rangle,...\}\rangle,D,H,IP\rangle
				\\\longrightarrow_{secdv4} \langle I,Unit$ $S,E,C,TL,\langle CS,\{...,\langle s,\{...,\langle b,\{...\},\{...,I,...\}\rangle,...\}\rangle,...\}\rangle,D,H,IP\rangle$
				\item[]
