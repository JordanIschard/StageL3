	...
	\section{Recherche d'Informations}\label{Recherche}
		...
		\section{Dernière version de la machine SECD concurrente}\label{SECDConc4}
			...
			\begin{itemize}
				...
				\item[]
				\item[] $\iota(l,s,i) =$ la fonction qui pour une liste de signaux courant l, un signal s et un identifiant de thread i donnés, renvoie une liste des signaux courant avec le signal s initialisé.
				\\\textbf{Exemple :} $\iota(\{...,\langle s,\{...\},emit\rangle,...\},s,id) = \{...,\langle s,\{...,\langle id,\{\}\rangle\},emit\rangle,...\}$
				\item[]
