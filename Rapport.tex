	...
	\section{Annexes}
		...
		\subsection{Les différentes versions faite pour rendre la machine SECD concurrente}
			...
			\subsubsection{1ère-2ème version des règles de la machine SECD Concurrente}\label{SECDConc1-2}
				...
				\begin{itemize}
					...
					\begin{itemize}
						...
						\item[] \textbf{Récupération de sauvegarde :} On a rien mais le dépôt comporte une sauvegarde donc on prends celle-ci.
						\smallbreak
						$\langle V~S,E,\emptyset,\langle S,E,C,D\rangle,W,ST,SI\rangle 
						\longmapsto_{secdv1-2} 
						\langle V~S',E,C',D,W,ST,SI\rangle$
						\item[]
					\end{itemize}
					...
					\begin{itemize}
						...
						\smallbreak $\langle S,E,\emptyset,\emptyset,\langle S',E',C,D\rangle$ $W,ST,SI\rangle 
						\longmapsto_{secdv1-2} 
						...
						\smallbreak  $\langle S,E,\emptyset,\emptyset,\emptyset,ST,SI\rangle 
						...
						\longmapsto_{secdv1-2} 
						\langle\epsilon,\emptyset,\emptyset,\emptyset,\emptyset,ST~\langle S,E,\langle s, C',C''\rangle~C,D\rangle,SI\rangle$ 
						\\si $s \notin SI$ et $s \in E$ 
						\item[]
			...
			\subsubsection{3ème version des règles de la machine SECD Concurrente}\label{SECDConc3}
				...
				\textbf{\textit{Soit}} $\langle S,E,C,D,W,ST,SI,H\rangle$ \textbf{\textit{avec :}}
				...
				\begin{itemize}
					...
					\item[] $H$ = $\epsilon$ 
					\begin{itemize}
						\item[|] $\langle e,\langle S,E,C,D,W,ST,SI,H\rangle\rangle$ 
					\end{itemize}
					\item[] $V$ = ... 
					\begin{itemize}
						\item[|] $erreur_{e}$
				...
				\smallbreak
				\begin{enumerate}
					\item $\langle S,E,b~C,D,W,ST,SI,H\rangle \longmapsto_{secdv3} \langle b~S,E,C,W,ST,SI,H\rangle$
					\item[]
					\item $\langle S,E,X~C,D,W,ST,SI,H\rangle \longmapsto_{secdv3} \langle V~S,E,C,D,W,ST,SI,H\rangle$
					\\où $V = E(X)$
					\item[]
					\item $\langle b_{1}~...~b_{n}~S,E,prim_{o^{n}}~C,D,W,ST,SI,H\rangle \longmapsto_{secdv3} \langle V~S,E,C,D,W,ST,SI,H\rangle$ 
					\\où $V = \delta(o^{n},b_1,...b_{n})$
					\item[]
					\item $\langle S,E,throw_{e}~C,D,W,ST,SI,H\rangle \longmapsto_{secdv3} \langle erreur_{e}~S,E,C,D,W,ST,SI,H\rangle$
					\item[]
					\item $\langle S,E,\langle X,C'\rangle~C,D,W,ST,SI,H\rangle \longmapsto_{secdv3} \langle\langle\langle X,C'\rangle,E\rangle~S,E,C,D,W,ST,SI,H\rangle$
					\item[]
					\item $\langle V~\langle\langle X,C'\rangle,E'\rangle~S,E,ap~C,D,W,ST,SI,H\rangle \longmapsto_{secdv3} \langle\epsilon,E'[X \leftarrow V],C',\langle S,E,C,D\rangle,W,ST,SI,H\rangle$
					\item[]
					\item $\langle V~S,E,\emptyset,\langle S',E',C,D\rangle,W,ST,SI,H\rangle \longmapsto_{secdv3} \langle V~S',E',C,D,W,ST,SI,H\rangle$
					\item[]
					\item $\langle V~Remp~S,E,ap~C,D,W,ST,SI,H\rangle \longmapsto_{secdv3} \langle V~S,E,C,D,W,ST,SI,H\rangle$
					\item[]
					\item $\langle Remp~V~S,E,ap~C,D,W,ST,SI,H\rangle \longmapsto_{secdv3} \langle V~S,E,C,D,W,ST,SI,H\rangle$
					\item[]
					\item $\langle S,E,bspawn~C'~espawn~C,D,W,ST,SI,H\rangle \longmapsto_{secdv3} \langle Remp~S,E,C,D,W~\langle S,E,C',D\rangle,ST,SI,H\rangle$
					\item[]
			    	\item $\langle S,E,\langle s, C',C''\rangle~C,D,W,ST,SI,H\rangle \longmapsto_{secdv3} \langle S,E,C'~C,D,W,ST,SI,H\rangle$ 
			    	\\si $s \in SI$ et $s \in E$ 
			    	\item[]
