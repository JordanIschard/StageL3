...
\end{itemize}
	...
	\improvement[inline]{Le $\lambda$-calcul est le modèle le plus communément accepté du calcul séquentiel.}
	...
	\improvement{Idée de transformation des termes. Seul mode de calcul pour des fonctions : l'application.}
	...
	\begin{itemize}
		...
		\end{ex}
		\improvement[inline]{Trouver un exemple}
	...
	\end{itemize}
	\improvement[inline]{Expliquer les contraintes sur la substitution pour éviter la capture de variable; donner unexemple de problème}
	\bigbreak
	...
	\change[inline]{A retravailler entièrement l'explication pour la forme normale}
	...
	\improvement[inline]{A justifier}
	...
	\improvement[inline]{Section à développer 2-3 pages}
	...
	Réactive ML utilise le modèle de programmation de concurrence coopérative. 
	\smallbreak
	L'analyse est découpée en 2 sous-analyses :
	\begin{itemize}
	...
	Le problème ici est que le contenu de la boucle peut s'effectuer instantanément alors qu'il faudrait attendre un instant logique pour l'exécuter. Par conséquent, on doit ajouter une \textbf{pause entre les lignes 6 et 7}.
	\bigbreak
