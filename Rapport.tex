...
\item[-] \hyperref[ZINC]{[2]} \change{Elements de base de caml light} développant toute la réflexion que l'on doit avoir pour créer un langage de programmation
...
lier une variable.
\improvement{Donner plus d'intuition sur la notion d'abstraction.}
...
\end{enumerate}
\improvement[inline]{Donner l'intuition des règles au fur et à mesure de leur introduction}
\bigbreak
...
\end{itemize}
\improvement[inline]{Donner l'intuition des règles au fur et à mesure de leur introduction. Expliquer la substitution avant en donnant l'intuition.}
\medbreak
...
ISWIM est un langage impératif à noyau fonctionnel ; de fait, c'est une syntaxe \change[inline]{ce n'est pas lisible ISWIM} lisible du $\lambda$-calcul à laquelle sont ajoutés des variables mutables et des définitions. Grâce au $\lambda$-calcul, ISWIM comporte des fonctions d'ordre supérieur et une portée lexicale des variables. Le but est de décrire des concepts en fonction d'autres concepts. Ce langage a fortement influencé les autres langages qui l'ont suivi, principalement dans la programmation fonctionnelle.
\medbreak
...
\textbf{On va définir une règle afin de simplifier les règles futurs :} 
\begin{itemize}
