  ...
  struct
    ...
    let rec equals_terme term1 term2 =
      match (term1,term2) with
        ...
        | (Abs_term(var1,terme1),Abs_term(var2,terme2))      ->   if (equal var1 var2) then (equals_terme terme1 terme2) else false
       
        | (App_term(terme1,terme2),App_term(terme3,terme4))  ->   (equals_terme terme1 terme3) && (equals_terme terme2 terme4)
