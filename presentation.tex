...
\date{06 juin 2019}
	...
	Les recherches menées au LIFO concernent la science informatique et les STIC (Système de Traitement des Infractions Constatées).}
	\bigbreak
		...
		\begin{columns}
			\begin{column}{5cm}
				...
				\begin{itemize}
					...
					\item Exploite la chaîne de contôle uniquement
				\end{itemize}
				\bigbreak
	...
	\begin{frame}
		...
		\begin{enumerate}
			\item  {\scriptsize $\langle S,\varepsilon,b~C,D\rangle 
				\longmapsto_{secd}
				\langle b~S,\varepsilon,C,D\rangle$}
			
			\item  {\scriptsize $\langle S,\varepsilon,X$ $C,D\rangle 
				\longmapsto_{secd}
				\langle V$ $S,\varepsilon,C,D\rangle$ où $V = \varepsilon(X)$}
			
			\item  {\scriptsize $\langle S,\varepsilon,\langle X,C'\rangle$ $C,D\rangle \longmapsto_{secd}
				\langle\langle\langle X,C'\rangle,\varepsilon\rangle$ $S,\varepsilon,C,D\rangle$}
			
			\item  {\scriptsize $\langle V$ $\langle\langle X,C'\rangle,\varepsilon'\rangle$ $S,\varepsilon,ap$ $C,D\rangle 
				\longmapsto_{secd}
				\langle\epsilon,\varepsilon'[X \leftarrow V],C',\langle S,\varepsilon,C,D\rangle\rangle$}
			
			\item  {\scriptsize $\langle V$ $S,\varepsilon,\emptyset,\langle S',\varepsilon',C',D\rangle\rangle \longmapsto_{secd}
				\langle V$ $S',\varepsilon',C',D\rangle$}
			
			\item  {\scriptsize $\langle b_{1}$ $...$ $b_{n}~S,\varepsilon,prim_{o^{n}}$ $C,D\rangle \longmapsto_{secd}
				\langle V$ $S,\varepsilon,C,D\rangle$ où $V = \delta(o^{n},b_1,...b_{n})$}
		\end{enumerate}
		\end{block}	
